message-unsupported-avm2 =
    Ruffle emülatörü, bu içerik tarafından kullanılan tüm ActionScript 3'ü, henüz tam olarak desteklemeyebilir.
    İçeriğin bazı bölümleri beklendiği gibi çalışmayabilir.
message-cant-embed =
