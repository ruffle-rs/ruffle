...
update-ruffle = Ažuriranje Ruffle-a
...
clipboard-message-cut = { " " } za rezanje
clipboard-message-paste = { " " } za lijepljenje
error-canvas-reload = Nije moguće ponovo učitati renderer platna kada je renderer platna već u upotrebi.
error-file-protocol =
    ...
    Umjesto toga, preporučujemo vam da postavite lokalni server ili koristite web demo ili desktop aplikaciju.
error-javascript-config =
    Ruffle je naišao na ozbiljan problem zbog pogrešne konfiguracije JavaScripta.
