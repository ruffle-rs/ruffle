...
enable-hardware-acceleration = Parece que a aceleração de hardware não é permitida. Enquanto Ruffle pode funcionar, pode ser irracionalmente lento. Você pode descobrir como permitir aceleração de hardware seguindo este link.
