...
esbuild.build({
    ...
    banner: {
        js: 'const __ruffle_script_url = (typeof document !== "undefined" && document.currentScript && document.currentScript.src) ? document.currentScript.src : (typeof location !== "undefined" ? location.href : "");',
    },
    define: {
        "process.env.NODE_ENV": JSON.stringify(
            process.env.NODE_ENV || "production",
        ),
        "import.meta.url": "__ruffle_script_url",
