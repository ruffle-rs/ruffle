...
This can be installed with `cargo install wasm-bindgen-cli --version 0.2.127`. Be sure to install this specific version of `wasm-bindgen-cli` to match the version used by Ruffle.
