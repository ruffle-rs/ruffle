...
/*
 * This test is the fifth test out of a series of tests, testing the result of getBounds / getRect when
 ...
 * File 1 (Parent7L8TestingThis.swf)
 * - getBounds should change to X.4 after the child calls getBounds because calls using the same target also set
 * - the state if the activation version is >= 8.
...
loader.loadClip("Parent7L8TestingThis.swf", mc);
