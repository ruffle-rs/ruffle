...
/*
 * This test is the fourth test out of a series of tests, testing the result of getBounds / getRect when
 ...
 * File 1 (Parent7L8getRect.swf)
 * - getBounds should change to X.4 after the child calls getRect because getBounds & getRect share the same
 * - state, and it's set to X.4 after a call of one of them with activation version >= 8.
...
loader.loadClip("Parent7L8getRect.swf", mc);
