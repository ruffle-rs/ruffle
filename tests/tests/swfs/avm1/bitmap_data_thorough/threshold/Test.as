...
function main() {
    ...
    opaqueBmd.setPixel32(1, 1, 0xFFFFFFFF);
    opaqueBmd.setPixel32(2, 1, 0x00000000);
    opaqueBmd.setPixel32(1, 2, 0x00000000);
    transparentBmd = new BitmapData(3, 3, true, 0x12345678);
    transparentBmd.setPixel32(0, 0, 0xFFFFFFFF);
    transparentBmd.setPixel32(1, 1, 0xFFFFFFFF);
    transparentBmd.setPixel32(2, 1, 0x00000000);
    transparentBmd.setPixel32(1, 2, 0x00000000);
    ...
    var functionsAndArgs = [
        [true, "threshold", transparentBmd, rect, point, "==", 0x33333333, 0xAAAAAAAA, 0x00FF0000, true]
    ];
