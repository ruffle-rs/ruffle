...
function main() {
    ...
    var functionsAndArgs = [
        [false, "getColorBoundsRect", 0x00FFFFFF, 0x00FF0000, false]
    ];
    ...
    for (var o = 0; o < objects.length; o++) {
        ...
        callWithSpecificArgs(objects[o][1], "getColorBoundsRect", [1, 0x00FF0000, false]);
        callWithSpecificArgs(objects[o][1], "getColorBoundsRect", [1, 0x00FF0000, true]);
        callWithSpecificArgs(objects[o][1], "getColorBoundsRect", [0, 0x00FF0000, false]);
        callWithSpecificArgs(objects[o][1], "getColorBoundsRect", [0, 0x00FF0000, true]);
        callWithSpecificArgs(objects[o][1], "getColorBoundsRect", [0, 0x000000DD, true]);
        callWithSpecificArgs(objects[o][1], "getColorBoundsRect", [0, 0x000000DD, false]);
        callWithSpecificArgs(objects[o][1], "getColorBoundsRect", [0x000000FF, 0x000000DD, true]);
        callWithSpecificArgs(objects[o][1], "getColorBoundsRect", [0x000000FF, 0x000000DD, false]);
        callWithSpecificArgs(objects[o][1], "getColorBoundsRect", [0xFF000000, 0xAA000000, true]);
        callWithSpecificArgs(objects[o][1], "getColorBoundsRect", [0xFF000000, 0xAA000000, false]);
        trace("");
        trace("");
    }
}
