...
function main() {
    ...
    var functionsAndArgs = [
        [true, "perlinNoise", 3, 3, 4, 100, false, false, 15, false, null],
        [true, "perlinNoise", 100, 80, 4, 100, true, true, 1, true, null]
    ];
        ...
        if (o < 2) {
            for (var c = 0; c < 16; c++) {
                for (var noise = 0; noise < 2; noise++) {
                    for (var octaves = 0; octaves < 3; octaves++) {
                        for (var grayscale = 0; grayscale < 2; grayscale++) {
                            for (var stitch = 0; stitch < 2; stitch++) {
                                callWithSpecificArgs(objects[o][1], printBmd, "perlinNoise", [3, 3, octaves, 100, stitch == 0, noise == 0, c, grayscale == 0]);
                            }
                        }
                    }
                }
