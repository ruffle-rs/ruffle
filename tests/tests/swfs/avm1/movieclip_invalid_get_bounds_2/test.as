...
/*
 * This test is the second test out of a series of tests, testing the result of getBounds / getRect when
 ...
 * - In this test, the oldest parent file's SWF version is >= 8.
 * - Therefore, even though all getBound calls are with the activation SWF version < 8, every getBounds
 * - call should return X.4, no matter whether and how many SWF files are loaded between the original
 * - file / the oldest parent file and the file calling getBounds.
