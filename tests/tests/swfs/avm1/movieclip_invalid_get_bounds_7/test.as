...
/*
 * This test is the seventh test out of a series of tests, testing the result of getBounds / getRect when
 ...
 * File 1 (Parent7LB8TestingThis.swf)
 * - getBounds should change to X.4 after the child calls getBounds because calls using the same target while the
 * - MovieClip doesn't have invalid bounds also set the state if the activation version is >= 8.
 * - This is different in Flash Player 10.
...
loader.loadClip("Parent7LB8TestingThis.swf", mc);
