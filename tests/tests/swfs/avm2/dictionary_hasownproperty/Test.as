...
trace('///a.hasOwnProperty(13)');
trace(a.hasOwnProperty(13));

trace('///a.hasOwnProperty(1.123)');
trace(a.hasOwnProperty(1.123));

trace('///a.hasOwnProperty("1.123")');
trace(a.hasOwnProperty("1.123"));

trace('///a.hasOwnProperty(undefined)');
trace(a.hasOwnProperty(undefined));
...
trace('///a.hasOwnProperty(new Test())');
trace(a.hasOwnProperty(new Test()));

trace('///a[a] = a');
a[a] = a;

trace(a.hasOwnProperty(a));
