package {
	...
	public class Test extends Sprite {
		...
		public function Test():void {
			...
			addImage(count++, testFilter(src, new ColorMatrixFilter(), new Point(-10, -10)));
			addImage(count++, testFilter(src, new ConvolutionFilter(3, 3, [0, -1, 0, -1, 5, -1, 0, -1, 0]), new Point(-10, -10)));
			addImage(count++, testFilter(src, new GradientGlowFilter(), new Point(-10, -10)));
			addImage(count++, testFilter(src, new GradientBevelFilter(), new Point(-10, -10)));
			...
			addImage(count++, testFilter(src, new BlurFilter(), new Point(-100, -100)));
