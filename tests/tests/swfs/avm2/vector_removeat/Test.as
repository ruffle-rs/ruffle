...
trace("/// a_bool.removeAt(1);");
trace(a_bool.removeAt(1));

trace("/// (contents of a_bool...)");
trace_vector(a_bool);

trace("/// a_bool.removeAt(0);");
trace(a_bool.removeAt(0));

trace("/// (contents of a_bool...)");
trace_vector(a_bool);

trace("/// b_bool.removeAt(-2);");
trace(b_bool.removeAt(-2));

trace("/// (contents of b_bool...)");
trace_vector(b_bool);

trace("/// b_bool.removeAt(-5);");
trace(b_bool.removeAt(-5));
...
trace("/// a_class.removeAt(0);");
trace(a_class.removeAt(0));

trace("/// a1_class === a_class[0];");
trace(a1_class === a_class[0]);

trace("/// b_class.removeAt(-3);");
trace(b_class.removeAt(-3));
