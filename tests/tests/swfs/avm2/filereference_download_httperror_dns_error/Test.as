package {
    ...
    public class Test extends Sprite {
        ...
        public function Test() {
            ...
            // test navigator simulates a DNS failure for "?debug-error-dns", which
            // never opens the connection (no "open" event).
            fileRef.download(new URLRequest("http://example.com/debug-success.txt?debug-error-dns"));
        }
