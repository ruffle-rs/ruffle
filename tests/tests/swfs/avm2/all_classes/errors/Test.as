package {
    ...
    public class Test extends Sprite {
        static const CLASSES:Array = ["DRMManagerError", "EOFError", "IOError", "IllegalOperationError", "InvalidSWFError", "MemoryError", "ScriptTimeoutError", "StackOverflowError"];
        ...
        public function lookupClass(className:String):Class {
            return getDefinitionByName("flash.errors::" + className);
        }
