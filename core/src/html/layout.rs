...
pub struct LayoutContext<'a, 'gc> {
    ...
    device_fonts_obey_kerning: bool,

    device_font_kerning_after_pixel_snap: bool,
...
impl<'a, 'gc> LayoutContext<'a, 'gc> {
    fn new(
        ...
        Self {
            ...
            is_word_wrap,
            font_type,
            device_fonts_obey_kerning,
            device_font_kerning_after_pixel_snap,
        }
    }
    ...
    fn lay_out_span(
        ...
        params.device_fonts_obey_kerning = self.device_fonts_obey_kerning;
        params.device_font_kerning_after_pixel_snap = self.device_font_kerning_after_pixel_snap;
...
pub fn lower_from_text_spans<'gc>(
    ...
    lower_from_text_spans_with_device_fonts(
        fs,
        context,
        movie,
        requested_width,
...
/// Construct a new FTE TextLine layout from text spans.
pub fn lower_from_text_spans_for_text_line<'gc>(
    fs: &FormatSpans,
    context: &mut UpdateContext<'gc>,
    movie: Arc<SwfMovie>,
    requested_width: Option<Twips>,
...
fn lower_from_text_spans_with_device_fonts<'gc>(
    fs: &FormatSpans,
    context: &mut UpdateContext<'gc>,
    movie: Arc<SwfMovie>,
    requested_width: Option<Twips>,
