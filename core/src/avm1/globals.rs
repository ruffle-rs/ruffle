...
mod tests {
    ...
    test_std!(boolean_function, boolean, 19,
        ...
        [10.0] => Value::Bool(true),
        [-10.0] => Value::Bool(true),
        [0.0] => Value::Bool(false),
        [std::f64::INFINITY] => Value::Bool(true),
        [std::f64::NAN] => Value::Bool(false),
        [""] => Value::Bool(false),
    ...
    test_std!(is_nan_function, is_nan, 19,
        ...
        [-10.0] => Value::Bool(false),
        [0.0] => Value::Bool(false),
        [std::f64::INFINITY] => Value::Bool(false),
        [std::f64::NAN] => Value::Bool(true),
        [""] => Value::Bool(false),
        ["Hello"] => Value::Bool(true),
        [" "] => Value::Bool(true),
        ["  5  "] => Value::Bool(true),
    ...
    test_std!(number_function, number, 19,
        ...
        [10.0] => Value::Number(10.0),
        [-10.0] => Value::Number(-10.0),
        [0.0] => Value::Number(0.0),
        [std::f64::INFINITY] => Value::Number(std::f64::INFINITY),
        [std::f64::NAN] => Value::Number(std::f64::NAN),
        [""] => Value::Number(0.0),
