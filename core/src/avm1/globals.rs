...
mod tests {
    ...
    test_std!(boolean_function, boolean, 19,
        ...
        &["".to_string().into()] => Value::Bool(false),
        &["Hello".to_string().into()] => Value::Bool(true),
        &[" ".to_string().into()] => Value::Bool(true),
        &["0".to_string().into()] => Value::Bool(true),
        &["1".to_string().into()] => Value::Bool(true),
        &[] => Value::Bool(false)
    );
    ...
    test_std!(boolean_function_swf6, boolean, 6,
        ...
        &[Value::Number(std::f64::NAN)] => Value::Bool(false),
        &["".to_string().into()] => Value::Bool(false),
        &["Hello".to_string().into()] => Value::Bool(false),
        &[" ".to_string().into()] => Value::Bool(false),
        &["0".to_string().into()] => Value::Bool(false),
        &["1".to_string().into()] => Value::Bool(true),
        &[] => Value::Bool(false)
    );
    ...
    test_std!(is_nan_function, is_nan, 19,
        ...
        &["Hello".to_string().into()] => Value::Bool(true),
        &[" ".to_string().into()] => Value::Bool(true),
        &["  5  ".to_string().into()] => Value::Bool(true),
        &["0".to_string().into()] => Value::Bool(false),
        &["1".to_string().into()] => Value::Bool(false),
        &["Infinity".to_string().into()] => Value::Bool(true),
        &["100a".to_string().into()] => Value::Bool(true),
        &["0x10".to_string().into()] => Value::Bool(false),
        &["0xhello".to_string().into()] => Value::Bool(true),
        &["0x1999999981ffffff".to_string().into()] => Value::Bool(false),
        &["0xUIXUIDFKHJDF012345678".to_string().into()] => Value::Bool(true),
        &["123e-1".to_string().into()] => Value::Bool(false),
        &[] => Value::Bool(true)
    );
    ...
    test_std!(number_function, number, 19,
        ...
        &["".to_string().into()] => Value::Number(0.0),
        &["Hello".to_string().into()] => Value::Number(std::f64::NAN),
        &[" ".to_string().into()] => Value::Number(std::f64::NAN),
        &["  5  ".to_string().into()] => Value::Number(std::f64::NAN),
        &["0".to_string().into()] => Value::Number(0.0),
        &["1".to_string().into()] => Value::Number(1.0),
        &["Infinity".to_string().into()] => Value::Number(std::f64::NAN),
        &["100a".to_string().into()] => Value::Number(std::f64::NAN),
        &["0x10".to_string().into()] => Value::Number(16.0),
        &["0xhello".to_string().into()] => Value::Number(std::f64::NAN),
        &["123e-1".to_string().into()] => Value::Number(12.3),
        &["0x1999999981ffffff".to_string().into()] => Value::Number(-2113929217.0),
        &["0xUIXUIDFKHJDF012345678".to_string().into()] => Value::Number(std::f64::NAN),
        &[] => Value::Number(0.0)
    );
}
