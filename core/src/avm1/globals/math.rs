...
mod tests {
    ...
    test_std!(test_abs, "abs",
        ...
        [-50.0] => Value::Number(50.0),
        [25.0] => Value::Number(25.0)
    );

    test_std!(test_acos, "acos",
        [] => Value::Number(NAN),
        [Value::Null] => Value::Number(NAN),
        [-1.0] => Value::Number(f64::acos(-1.0)),
        [0.0] => Value::Number(f64::acos(0.0)),
        [1.0] => Value::Number(f64::acos(1.0))
    );
    ...
    test_std!(test_asin, "asin",
        [] => Value::Number(NAN),
        [Value::Null] => Value::Number(NAN),
        [-1.0] => Value::Number(f64::asin(-1.0)),
        [0.0] => Value::Number(f64::asin(0.0)),
        [1.0] => Value::Number(f64::asin(1.0))
    );
    ...
    test_std!(test_atan, "atan",
        [] => Value::Number(NAN),
        [Value::Null] => Value::Number(NAN),
        [-1.0] => Value::Number(f64::atan(-1.0)),
        [0.0] => Value::Number(f64::atan(0.0)),
        [1.0] => Value::Number(f64::atan(1.0))
    );
    ...
    test_std!(test_cos, "cos",
        ...
        [std::f64::consts::PI] => Value::Number(f64::cos(std::f64::consts::PI))
    );

    test_std!(test_exp, "exp",
        [] => Value::Number(NAN),
        [Value::Null] => Value::Number(NAN),
        [1.0] => Value::Number(f64::exp(1.0)),
        [2.0] => Value::Number(f64::exp(2.0))
    );

    test_std!(test_floor, "floor",
        [] => Value::Number(NAN),
        [Value::Null] => Value::Number(NAN),
        [12.5] => Value::Number(12.0)
    );
    ...
    test_std!(test_round, "round",
        ...
        [Value::Null] => Value::Number(NAN),
        [12.5] => Value::Number(13.0),
        [23.2] => Value::Number(23.0)
    );

    test_std!(test_sin, "sin",
        [] => Value::Number(NAN),
        [Value::Null] => Value::Number(NAN),
        [0.0] => Value::Number(f64::sin(0.0)),
        [std::f64::consts::PI / 2.0] => Value::Number(f64::sin(std::f64::consts::PI / 2.0))
    );

    test_std!(test_sqrt, "sqrt",
        [] => Value::Number(NAN),
        [Value::Null] => Value::Number(NAN),
        [0.0] => Value::Number(f64::sqrt(0.0)),
        [5.0] => Value::Number(f64::sqrt(5.0))
    );

    test_std!(test_tan, "tan",
        [] => Value::Number(NAN),
        [Value::Null] => Value::Number(NAN),
        [0.0] => Value::Number(f64::tan(0.0)),
        [1.0] => Value::Number(f64::tan(1.0))
    );
