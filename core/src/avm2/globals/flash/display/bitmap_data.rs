...
use crate::avm2::error::{
    Error2004Type, make_error_2004, make_error_2005, make_error_2006, make_error_2008,
    make_error_2015, make_error_2027,
};
...
pub fn encode<'gc>(
    ...
    if let Some(bitmap_data) = this.as_bitmap_data() {
        ...
        region.clamp(bitmap_data.width(), bitmap_data.height());
