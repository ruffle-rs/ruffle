...
use crate::avm2::object::{date_allocator, DateObject, FunctionObject, TObject};
...
pub fn instance_init<'gc>(
    ...
    if let Some(date) = this.as_object().and_then(|this| this.as_date_object()) {
...
pub fn time<'gc>(
    ...
    if let Some(this) = this.as_object().and_then(|this| this.as_date_object()) {
