...
impl<'gc> OptValue<'gc> {
    ...
    pub fn exact_class(self) -> Option<Class<'gc>> {
        if self.is_exact_class {
            self.class
        } else if self.class.is_some_and(|c| c.is_final()) {
            self.class
        } else {
            None
        }
...
impl<'gc> AbstractState<'gc> {
    ...
    fn merged_with(
        ...
        for i in 0..new_locals.len() {
            ...
            new_locals.set(i, our_local.merged_with(other_local));
        }
        ...
        for i in 0..new_stack.len() {
            ...
            new_stack.set(i, our_entry.merged_with(other_entry));
        }
        ...
        for i in 0..new_scope_stack.len() {
            ...
            new_scope_stack.set(i, our_scope.0.merged_with(other_scope.0), our_scope.1);
        }
