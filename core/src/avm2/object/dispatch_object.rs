...
#[collect(no_drop)]
pub struct DispatchObject<'gc>(pub GcCell<'gc, DispatchObjectData<'gc>>);

#[derive(Clone, Collect, Copy, Debug)]
#[collect(no_drop)]
pub struct DispatchObjectWeak<'gc>(pub GcWeakCell<'gc, DispatchObjectData<'gc>>);
...
impl<'gc> TObject<'gc> for DispatchObject<'gc> {
    ...
    fn downgrade(&self) -> WeakObject<'gc> {
        WeakObject::DispatchObject(DispatchObjectWeak(GcCell::downgrade(self.0)))
    }
