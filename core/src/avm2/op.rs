...
pub enum Op<'gc> {
    ...
    //  - If the multiname has a lazy name and a static namespace, the verifier
    //    emits GetPropertyFast. `allow_indexing` is set when the multiname
    //    contains the public namespace and is not an attribute multiname.
