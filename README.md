...
[Nightly builds](https://github.com/ruffle-rs/ruffle/releases) of Ruffle are available for desktop and web platforms including the browser extension. To download a build, click the Assets dropdown, then click the appropriate file for your platform.
