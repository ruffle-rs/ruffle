...
/// Pixel Dender disassembler for debugging purposes.
#[allow(unused)]
...
impl PixelBenderShaderDisassembly<'_> {
        ...
        for param in &self.0.params {
            match param {
                PixelBenderParam::Normal {
                    ...
                    write!(f, "param {qualifier} {name:?} {param_type} ")?;
                    self.fmt_reg(f, reg)?;
                ...
                PixelBenderParam::Texture {
                    ...
                    writeln!(f, "param_texture {name:?} {index} {channels}")?;
                }
            }
        }
        Ok(())
    ...
    fn opcode_to_str(&self, opcode: Opcode) -> &'static str {
        match opcode {
            ...
            Opcode::PBJMeta1 => "pbjmeta1",
            Opcode::PBJParam => "pbjparam",
            Opcode::PBJMeta2 => "pbjmeta2",
            Opcode::PBJParamTexture => "pbjparamtexture",
            Opcode::Name => "name",
