...
pub struct Shaders {
    ...
    pub bitmap_triangle_shader: wgpu::ShaderModule,
...
impl Shaders {
    pub fn new(device: &wgpu::Device) -> Self {
        ...
        let bitmap_triangle_shader = make_shader(
            device,
            "bitmap_triangles.wgsl",
            include_str!("../shaders/bitmap_triangles.wgsl"),
        );
