...
mod tests {
    ...
    macro_rules! define_test_helpers {
    ...
    mod preferences {
        ...
        define_test_helpers!(read_preferences, PreferencesAndDocument, PreferencesWriter);
    ...
    mod bookmarks {
        ...
        define_test_helpers!(read_bookmarks, BookmarksAndDocument, BookmarksWriter);
