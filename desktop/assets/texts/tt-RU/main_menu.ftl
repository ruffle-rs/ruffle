...
file-menu = Файл
file-menu-open-file = Файлны ачу...
file-menu-open-directory = Папканы ачу...
...
debug-menu-open-stage = Сәхнә турында мәгълүмат
debug-menu-open-root-movie-clip = Төп MovieClip’ны карау
debug-menu-open-movie = Клипны карау
debug-menu-open-movie-list = Белгән клиплар күрсәтү
debug-menu-open-domain-list = Доменнарны күрсәтү
debug-menu-search-display-objects = Күрсәтү өчен объектлар эзләү...
view-menu = Күренеш
