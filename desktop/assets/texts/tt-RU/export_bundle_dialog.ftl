export-bundle-dialog-title = Ruffle пакетын экспортлау
export-bundle-dialog-bundle-name = Пакет исеме:
export-bundle-dialog-files-description = Пакетка кертәсе файлларны сайлагыз:
...
export-bundle-dialog-info-description = Ruffle пакет ул SWF файлын эшләтеп җибәрү өчен кирәк булган барлык әйберләрне үз эченә алган универсаль пакет: барлык кирәкле ресурслар һәм көйләүләр. Bundle ярдәмендә SWF шунда ук эшли — югалган файллар юк, кул белән көйләү кирәкми, бары тик ач та эшләт.
