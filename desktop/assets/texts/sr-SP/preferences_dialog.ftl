...
theme-dark = Тамна
gamemode-tooltip =
    GameMode привремено примењује скуп оптимизација на ваш рачунар и/или Ruffle.
    Ruffle захтева GameMode само приликом репродукције филма.
gamemode-default = Подразумевано
gamemode-default-tooltip = GameMode ће бити омогућен само када је подешавање напајања подешено на високо.
