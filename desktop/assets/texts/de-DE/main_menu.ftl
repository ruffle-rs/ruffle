...
help-menu-sponsor-development = Sponsor-Entwicklung...
help-menu-translate-ruffle = Ruffle übersetzen...
help-menu-about = Über Ruffle
debug-menu = Debug-Werkzeuge
debug-menu-open-stage = Bühneninformationen anzeigen
debug-menu-open-movie = Film ansehen
debug-menu-open-movie-list = Zeige Bekannte Filme
debug-menu-search-display-objects = Anzeigeobjekte durchsuchen...
