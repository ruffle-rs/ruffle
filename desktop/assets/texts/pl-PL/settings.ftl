...
open-url-mode = Otwieraj łącza
open-url-mode-allow = Zezwól
open-url-mode-confirm = Pytaj
open-url-mode-deny = Odmów
load-behavior = Sposób ładowania
load-behavior-streaming = Strumieniowy
load-behavior-delayed = Opóźniony
load-behavior-blocking = Blokujący
...
quality-high8x8linear = Wysoka (8x8) liniowa
quality-high16x16 = Wysoka (16x16)
quality-high16x16linear = Wysoka (16x16) liniowa
letterbox = Letterbox
letterbox-on = Włącz
...
align-bottom-left = Lewy dolny róg
align-top-right = Prawy górny róg
align-bottom-right = Prawy dolny róg
align-force = Wymuś
