...
help-menu-translate-ruffle = Preložiť Ruffle...
help-menu-about = O Ruffle
debug-menu = Nástroje na ladenie
debug-menu-open-stage = Zobraziť informácie o etape
debug-menu-open-movie = Zobraziť film
debug-menu-open-movie-list = Zobraziť známe filmy
debug-menu-search-display-objects = Hľadať v objektoch zobrazenia...
