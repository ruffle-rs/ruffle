        ...
        .and_then(|e| e.downcast_ref::<rustls::Error>())
    {
        match tls_err {
            rustls::Error::InvalidCertificate(reason) => match reason {
                ...
                rustls::CertificateError::NotValidYet => "notYetValid",
                rustls::CertificateError::NotValidForName => "principalMismatch",
                rustls::CertificateError::Revoked => "revoked",
                rustls::CertificateError::UnknownIssuer => "untrustedSigners",
                _ => "invalid",
            },
            _ => "unknown",
        }
